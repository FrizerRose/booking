                ...
                <span class="o-icon c-card-service_image u-objfit">
                  ...
                  >
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M7.567 2.293A1 1 0 018.274 2h7.452a1 1 0 01.707.293l5.274 5.274a1 1 0 01.293.707v7.452a1 1 0 01-.293.707l-5.274
                      5.274a1 1 0 01-.707.293H8.274a1 1 0 01-.707-.293l-5.274-5.274A1 1 0 012 15.726V8.274a1 1 0
                      01.293-.707l5.274-5.274zM8.688 4L4 8.688v6.624L8.688 20h6.624L20 15.312V8.688L15.312 4H8.688z"
                    />
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
